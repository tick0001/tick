...
**[tickand.fr](https://tickand.fr)** · **[Essayer la démonstration](https://tick-demo.tickand.fr)** —
...
à un point près. Les dix-sept modules du périmètre fonctionnel sont couverts, l'API compte 180
opérations documentées, et la suite fait 2 352 tests — dont des tests d'intégration sur une vraie
...
pnpm test        # 2 352 tests — nécessite les services démarrés
