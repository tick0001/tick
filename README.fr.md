...
base PostgreSQL qui vérifient l'isolation entre entités. S'y ajoutent 35 parcours de bout en
...
pnpm test        # 2 338 tests — nécessite les services démarrés
...
make parcours    # 35 parcours de bout en bout, dans un navigateur
