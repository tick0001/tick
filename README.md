...
operations, and the suite runs 2 352 tests — including integration tests against a real PostgreSQL
...
pnpm test        # 2 352 tests — requires the services to be running
