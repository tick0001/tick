...
operations, and the suite runs 2 299 tests — including integration tests against a real PostgreSQL
...
pnpm test        # 2 299 tests — requires the services to be running
