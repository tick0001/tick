...
operations, and the suite runs 2 333 tests — including integration tests against a real PostgreSQL
...
pnpm test        # 2 333 tests — requires the services to be running
