...
operations, and the suite runs 2 376 tests — including integration tests against a real PostgreSQL
...
pnpm test        # 2 376 tests — requires the services to be running
